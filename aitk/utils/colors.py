# -*- coding: utf-8 -*-
# ***************************************************
# aitk.robots: Python Artificial Intelligence Toolkit
#
# Copyright (c) AITK Developers
#
...
XKCD_COLOR_NAMES = {"xkcd:" + name: value for name, value in XKCD_COLOR_NAMES.items()}
...
COLOR_NAMES = {}
COLOR_NAMES.update(XKCD_COLOR_NAMES)
COLOR_NAMES.update(CSS4_COLOR_NAMES)
...
class Color:
    def __init__(self, red, green=None, blue=None, alpha=None):
        ...
        Args:
            * red (int, list, Color, or str): red, list, Color, or color name
            * green (int, optional): green, or alpha if red is str (color name)
            * blue (int, optional): blue
            * alpha (int, optional): - alpha
        ...
        if isinstance(red, str):
            _alpha = green if green is not None else None
            if red.startswith("#"):
                # encoded hex color
